...
const SignIn = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen  bg-cover bg-center relative   ">
      ...
      <div className="bg-white p-8 rounded-lg shadow-md shadow-slate-300 relative z-10 max-w-sm w-full ">
        <h2 className="text-center text-2xl font-bold mb-4">Sign in to Our Culture</h2>
        <p className="text-center text-sm mb-4">
          Don’t have an account? <Link to="/SignUp" className="text-blue-500">Get Started</Link>
        </p>
        <br />
