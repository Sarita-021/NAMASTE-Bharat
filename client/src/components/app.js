        ...
        <div className="App">
            <Router>
                ...
                <Routes>
                    ...
                    {/* Traveller Routes */}
                    <Route exact path="/purchase-history" element={<Purchase_History />} />

                    {/* Admin Routes */}
                    <Route exact path="/admin/dashboard" element={<Dashboard />} />
                    <Route exact path="/admin/user-management" element={<User_Management />} />
                    <Route exact path="/admin/content-management" element={<Content_Management />} />
                    <Route exact path="/admin/analysis" element={<Analysis />} />

                    {/* Artisan Routes */}
                    <Route exact path="/educator/product-listing" element={<Product_Listing />} />
                    <Route exact path="/educator/product-catalog" element={<Product_Catalog />} />
                    <Route exact path="/educator/order-processing" element={<Order_Processing />} />
