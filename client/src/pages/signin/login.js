...
const Login = (props) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const { data } = await axios.post('/api/v1/user/login', {   //Calling Login Controller
        ...
        <div className="flex items-center justify-center min-h-screen  bg-cover bg-center relative   ">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md shadow-slate-300 relative z-10 max-w-sm w-full ">
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                    ...
                    <button
                        type="submit"
                        className="btn w-full bg-black text-white py-2 rounded-lg font-semibold hover:bg-gray-900"
                    >
                        Login
                    </button>
                </form>
