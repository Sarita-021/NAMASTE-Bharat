        ...
        <>
            <div className="flex justify-center items-center bg-slate-100">
                ...
                <div className="w-full h-screen p-4 bg-white shadow-xl rounded-lg">
                    ...
                    <form onSubmit={profilePhotoUpdate} encType="multipart/form-data">
                        ...
                        >
                            {isUploading ? "Uploading..." : "Upload"} {/* Show uploading status */}
                        </button>
                    </form>
                    ...
                    {isEditing && (
                        ...
                        >
                            {isSaving ? "Saving..." : "Save changes"} {/* Show saving status */}
                        </button>
                    )}
                    ...
                    <div className="flex items-center justify-between mt-4 bg-red-200 rounded-lg">
                        ...
                        <button onClick={deleteUser} className="bg-red-500 text-white px-3 py-2 rounded-md m-3">
                            Delete Your Account
                        </button>
                    </div>
                </div>
